...
async function handleRequest(request, env, ctx) {
  ...
  const cspHeader = `
    base-uri 'self';
    script-src 'strict-dynamic' https://www.clarity.ms https://copilot.microsoft.com https://picassostaticassetsstg.azureedge.net/ https://challenges.cloudflare.com/ 'self' 'nonce-${nonce}';
